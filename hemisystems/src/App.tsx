...
import HemisystemsMethod from "./components/HemisystemsMethod";
import BlueprintBuilder from "./components/BlueprintBuilder";
import TechEcosystem from "./components/TechEcosystem";
import HemisystemsLab from "./components/HemisystemsLab";
...
export default function App() {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case "method":
        return <HemisystemsMethod />;
      case "blueprint":
        return <BlueprintBuilder />;
      case "ecosystem":
        return <TechEcosystem />;
      case "lab":
        return <HemisystemsLab />;
      case "industries":
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center space-x-6 text-xs font-mono text-gray-550">
                <span>© 2026 HEMISYSTEMS Co. All Rights Reserved.</span>
