            ...
            <div className="rounded-lg border border-white/10 bg-slate-950 p-8 space-y-8 shadow-2xl relative overflow-hidden">
               ...
               <div className="border-t border-white/10 pt-8 mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                 <p className="font-mono text-[9px] uppercase tracking-widest text-gray-500 max-w-sm leading-relaxed">
                   Submit these findings strictly to Himisystems enterprise architecture group for comprehensive roadmap drafting.
                 </p>
                 <button
                 ...
                 >
                   ...
                   <span>Request a System Review from Himisystems</span>
                 </button>
               </div>
            </div>
          </motion.div>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center space-y-6">
              ...
              <div className="space-y-2 max-w-md">
                ...
                <p className="font-sans text-sm text-gray-400 leading-relaxed">
                  Your assessment vectors have been securely forwarded. A Himisystems principal architect will contact {corpMail} within 24 operational hours.
                </p>
              </div>
              <button
                onClick={handleReset}
